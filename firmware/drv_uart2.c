...
*/
        ...
        #define DRV_UART2_CONFIG_TX_BYTEQ_LENGTH 50
#endif
#ifndef DRV_UART2_CONFIG_RX_BYTEQ_LENGTH
        #define DRV_UART2_CONFIG_RX_BYTEQ_LENGTH 50
#endif
...
*/
        ...
        #define DRV_UART2_CONFIG_BAUD_RATE 115200
#endif
...
uint8_t uart2_rxByteQ[DRV_UART2_CONFIG_RX_BYTEQ_LENGTH] ;
...
#define DRV_UART2_TX_FIFO_LENGTH 4
#define DRV_UART2_RX_FIFO_LENGTH 4 
...
void DRV_UART2_InitializerDefault (void)
{
   ...
   U2BRG = ((clock_state.fcy / DRV_UART2_CONFIG_BAUD_RATE)/16)-1; 
   ...
   U2BRG = ((clock_state.fcy / DRV_UART2_CONFIG_BAUD_RATE)/4)-1;
...
bool DRV_UART2_RXBufferIsFull (void) {
    return(drv_uart2_obj.rxStatus.s.full);
}
...
bool DRV_UART2_TXBufferIsEmpty(void) {
    return(drv_uart2_obj.txStatus.s.empty);
}
