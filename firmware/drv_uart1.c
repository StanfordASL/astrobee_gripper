...
*/
        ...
        #define DRV_UART1_CONFIG_TX_BYTEQ_LENGTH 50
#endif
#ifndef DRV_UART1_CONFIG_RX_BYTEQ_LENGTH
        #define DRV_UART1_CONFIG_RX_BYTEQ_LENGTH 50
#endif
...
*/
        ...
        #define DRV_UART1_CONFIG_BAUD_RATE 115200
#endif
...
void DRV_UART1_InitializerDefault (void)
{
   ...
   U1BRG = ((clock_state.fcy / DRV_UART1_CONFIG_BAUD_RATE)/16)-1; 
